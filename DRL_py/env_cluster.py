...
class env:
    ...
    def initial_setup(self):
        print("\n Forming base case...\n")
        p = subprocess.run(['sh', 'env_initial_setup_cluster.sh', str(self.base_setup_end_time)], check=True)
    ...
    def fill_buffer(self):
        ...
        for n in np.arange(self.n_worker):
            ...
            proc[buffer_counter] = subprocess.Popen(
                ['sh', 'start_traj_hpc.sh', str(buffer_counter), str(trajectory_end_time)])
